...
* [ipyleaflet] (0.12.6): a [Jupyter] / [Leaflet.js] bridge enabling interactive maps in [Jupyter Notebook].
...
(datascience37)~/datascience$ pip install pip==20.1
(datascience37)~/datascience$ pip install setuptools==46.1.3
